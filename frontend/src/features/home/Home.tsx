          ...
          <section id="about" className="py-16">
            <div className="container mx-auto text-center">
              ...
              <p className="max-w-2xl mx-auto">
                ToyCycle is a dynamic platform aimed at fostering a
                community-based toy exchange. Our goal is to enable families to
                exchange toys or use tokens as a flexible, gamified currency
                within the platform.
              </p>
            </div>
          </section>
            ...
            <div className="container mx-auto text-center">
              ...
              <ul className="list-disc list-inside max-w-2xl mx-auto text-left">
                ...
                <li className="flex items-center gap-2">
                  ...
                  claim toys from others, with a transparent transaction
                  history.
                </li>
              </ul>
            </div>
        ...
        <ParallaxLayer offset={3} speed={1}>
          <section id="how-it-works" className="py-16">
            <div className="container mx-auto text-center">
              ...
              <ul className="list-decimal list-inside max-w-2xl mx-auto text-left">
                <li className="flex gap-2 items-center">
                  <FaAngleDoubleDown /> Register for a free account and create
                  your profile.
                </li>
                <li className="flex gap-2 items-center">
                  <FaAngleDoubleDown /> List toys you want to exchange or browse
                  available toys.
                </li>
                <li className="flex gap-2 items-center">
                  <FaAngleDoubleDown /> Use tokens to claim toys from others or
                  convert your toys into tokens if an exchange is not
                  immediately available.
                </li>
                <li className="flex gap-2 items-center">
                  <FaAngleDoubleDown /> Manage your toy listings and token
                  balance easily through your dashboard.
                </li>
              </ul>
            </div>
          </section>
